            ...
            <v-layout column fill-height class="stat_layout">
              <v-flex class="pa-2">
                <v-layout>
                  ...
                  <!--<v-slider tabindex="-1" style=" height: 10px;" v-if="bet.winSide === 1"-->
                  <!--v-model="bet.power"-->
                  ...
                  <v-slider @click="focus" tabindex="-1" style=" height: 10px;" v-if="bet.winSide === 1"
                            v-model="bet.power"
                            :max="listReadyPlayers.length * (odds.live.team_A.max / 100)"
                            :min="5"
                            :step="5"
                  ...
                  <v-slider @click="focus" tabindex="-1" style=" height: 10px;" v-else-if="bet.winSide === 3"
                            v-model="bet.power"
